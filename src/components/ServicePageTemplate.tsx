  ...
  return (
    <>
      ...
      <section className="section-shell pb-20 sm:pb-24">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-indigo-700 via-indigo-600 to-blue-600 px-6 py-12 text-white sm:px-10">
          <div className="absolute -right-14 -top-14 h-52 w-52 rounded-full bg-white/10 blur-2xl" />
          <div className="absolute -bottom-16 left-8 h-48 w-48 rounded-full bg-blue-300/20 blur-2xl" />
